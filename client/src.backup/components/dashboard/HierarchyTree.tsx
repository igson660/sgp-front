...
import { Federacao, ENOADS, Regional, Igreja } from '@/types/confradac';
...
function TreeNode({ label, icon, count, level, children, defaultExpanded = false }: TreeNodeProps) {
...
interface HierarchyTreeProps {
  federacao: Federacao;
  onEntityClick?: (level: string, id: string, name: string) => void;
}

export function HierarchyTree({ federacao, onEntityClick }: HierarchyTreeProps) {
  return (
