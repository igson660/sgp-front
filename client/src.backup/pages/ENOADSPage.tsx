        ...
        <div className="p-8">
          <div className="mb-8 grid grid-cols-1 gap-4 md:grid-cols-3">
            <div className="rounded-lg border border-gray-200 bg-white p-4">
              <p className="text-sm font-medium text-gray-600">Total de ENOADs</p>
              <p className="mt-2 text-3xl font-bold text-gray-900">{federacao.totalENOADS}</p>
            </div>
            <div className="rounded-lg border border-gray-200 bg-white p-4">
              <p className="text-sm font-medium text-gray-600">Total de Regionais</p>
              <p className="mt-2 text-3xl font-bold text-gray-900">{federacao.totalRegionais}</p>
            </div>
            <div className="rounded-lg border border-gray-200 bg-white p-4">
          ...
          <section>
            <h2 className="mb-4 text-xl font-bold text-gray-900">Lista de ENOADs</h2>
